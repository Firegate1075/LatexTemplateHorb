...
\lstset{%
	...
	aboveskip=\baselineskip	% some space to text above
} % uses textcomp
...
%bibliography
\usepackage[style=alphabetic, %authortitle, %Zitierstil
...
\usepackage[nameinlink]{cleveref} % better ref command
\Crefname{listing}{Code}{Code} % rename "Listing" to "Code" when referencing
\newcommand{\anfz}[1]{\glqq{}#1\grqq{}} % Setzt Wort in anführungszeichen

\usepackage{makecell} % better cell fomatting in tables
